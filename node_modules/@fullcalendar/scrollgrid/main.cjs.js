...
var ScrollGrid = /** @class */ (function (_super) {
    ...
    ScrollGrid.prototype.render = function () {
        ...
        }, renderMacroColGroup(colGroupStats, shrinkWidths), Boolean(!isBuggy && headSectionNodes.length) && common.createElement.apply(void 0, tslib.__spreadArrays(['thead', {}], headSectionNodes)), Boolean(!isBuggy && bodySectionNodes.length) && common.createElement.apply(void 0, tslib.__spreadArrays(['tbody', {}], bodySectionNodes)), Boolean(!isBuggy && footSectionNodes.length) && common.createElement.apply(void 0, tslib.__spreadArrays(['tfoot', {}], footSectionNodes)), isBuggy && common.createElement.apply(void 0, tslib.__spreadArrays(['tbody', {}], headSectionNodes, bodySectionNodes, footSectionNodes)));
    };
...
function renderMacroColGroup(colGroupStats, shrinkWidths) {
    ...
    return common.createElement.apply(void 0, tslib.__spreadArrays(['colgroup', {}], children));
}
