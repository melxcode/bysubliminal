...
const TimelineOppositeContent = /*#__PURE__*/React.forwardRef(function TimelineOppositeContent(props, ref) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_Typography.default, (0, _extends2.default)({
    component: "div",
    className: (0, _clsx.default)(classes.root, contextClasses.oppositeContent, classes[`align${(0, _utils.capitalize)(align)}`], className),
    ref: ref
  }, other));
});
