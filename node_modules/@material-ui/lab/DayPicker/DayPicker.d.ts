...
export interface DayPickerProps<TDate, TView extends DayPickerView = DayPickerView> extends ExportedCalendarProps<TDate>, ExportedYearPickerProps<TDate>, ExportedCalendarHeaderProps<TDate> {
    className?: string;
    date: TDate | null;
    /**
...
declare const _default: <TDate>(props: DayPickerProps<TDate, DayPickerView> & React.RefAttributes<HTMLDivElement>) => JSX.Element;
/**
 *
 * API:
 *
