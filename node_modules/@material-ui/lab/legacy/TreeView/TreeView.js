...
var TreeViewRoot = experimentalStyled('ul', {}, {
  name: 'MuiTreeView',
  slot: 'Root',
...
var TreeView = /*#__PURE__*/React.forwardRef(function TreeView(inProps, ref) {
  ...
  var getNextNode = function getNextNode(id) {
    ...
    var nextSibling = siblings[siblings.indexOf(id) + 1];
    ...
    var parent = nodeMap.current[node.parentId];

    if (parent) {
      var parentSiblings = getNavigableChildrenIds(parent.parentId);
