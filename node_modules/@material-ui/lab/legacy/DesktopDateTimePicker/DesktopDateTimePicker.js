...
import { dateTimePickerConfig } from '../DateTimePicker/DateTimePicker';
...
var DefaultToolbarComponent = dateTimePickerConfig.DefaultToolbarComponent,
    useInterceptProps = dateTimePickerConfig.useInterceptProps,
    useValidation = dateTimePickerConfig.useValidation;
...
var DesktopDateTimePicker = /*#__PURE__*/React.forwardRef(function DesktopDateTimePicker(inProps, ref) {
  var allProps = useInterceptProps(inProps); // This is technically unsound if the type parameters appear in optional props.
  ...
  return /*#__PURE__*/_jsx(DesktopWrapper, _extends({}, other, wrapperProps, {
