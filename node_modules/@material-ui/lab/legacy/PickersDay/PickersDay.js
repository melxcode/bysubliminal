...
var PickersDay = /*#__PURE__*/React.forwardRef(function PickersDay(props, forwardedRef) {
  var allowKeyboardControl = props.allowKeyboardControl,
      ...
      other = _objectWithoutProperties(props, ["allowKeyboardControl", "allowSameDateSelection", "autoFocus", "classes", "className", "day", "disabled", "disableHighlightToday", "disableMargin", "hidden", "isAnimating", "onClick", "onDayFocus", "onDaySelect", "onFocus", "onKeyDown", "outsideCurrentMonth", "selected", "showDaysOutsideCurrentMonth", "today"]);
  ...
  var dayClassName = clsx(classes.root, className, selected && classes.selected, !disableMargin && classes.dayWithMargin, !disableHighlightToday && isToday && classes.today, outsideCurrentMonth && showDaysOutsideCurrentMonth && classes.dayOutsideMonth);
