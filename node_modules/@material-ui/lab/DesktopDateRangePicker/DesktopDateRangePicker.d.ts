...
import { RangeInput, AllSharedDateRangePickerProps } from '../DateRangePicker/RangeTypes';
...
export interface DesktopDateRangePickerProps<TDate = unknown> extends BaseDateRangePickerProps<TDate>, AllSharedDateRangePickerProps<TDate>, DesktopWrapperProps {
}
